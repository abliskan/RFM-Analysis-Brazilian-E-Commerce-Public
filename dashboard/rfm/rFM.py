...
def create_rfm_df_quantile(df):
    ...
    # rfm_df_score['rfm_score'] = rfm_df_score['recency_quartile'].astype(float) + rfm_df_score['frequency_quartile'].astype(float) + rfm_df_score['monetary_quartile'].astype(float)
    
    rfm_df_output = 'data/merge_rfm_dataset.csv'
